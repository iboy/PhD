	...
	public static Vector2[][] data {
		get {
			if (points == null) {
				...
				// )
				points[41] = new Vector2[] {new Vector2(0.15f, 0f), new Vector2(0.45f, -0.25f), new Vector2(0.45f, -0.25f), new Vector2(0.45f, -0.75f), new Vector2(0.15f, -1f), new Vector2(0.45f, -0.75f)};
				// +
				...
				// /
				points[47] = new Vector2[] {new Vector2(0.6f, 0f), new Vector2(0f, -1f)};
				// 0
